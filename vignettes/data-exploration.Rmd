...
Latest data available used by default - see [data sources](https://www.samabbott.co.uk/EstZoonoticTB/articles/data-sources.html) and [data linkage](https://www.samabbott.co.uk/EstZoonoticTB/articles/data-linkage.html) for details. To instead explore the complete dataset comment out the `get_latest_combined_data` call and rerun the analysis. 
