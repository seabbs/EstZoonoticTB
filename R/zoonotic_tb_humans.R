...
#'   \item{prop_tb_z}{Proportion of TB cases that are zoonotic (numeric)}
#'   \item{prop_tb_z_lo}{Lower bound (95% CI) proportion of TB cases that are zoonotic (numeric)}
#'   \item{prop_tb_z_hi}{Upper bound (95% CI) proportion of TB cases that are zoonotic (numeric)}
#'   \item{prop_tb_z_se}{Standard error of the  proportion of TB cases that are zoonotic (numeric)}
#' }
"zoonotic_tb_humans"